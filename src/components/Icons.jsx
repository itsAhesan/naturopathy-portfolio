...
// Lightweight inline SVG icons to avoid heavy icon library imports
export const LeafIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2C6.5 6 2 12 2 18c0 2 1.5 3.5 3.5 3.5C8 21.5 12 18 12 18s4 3.5 6.5 3.5C20.5 21.5 22 20 22 18c0-6-4.5-12-10-16z" />
    <path d="M12 2v16" />
  </svg>
)
...
export const FlaskIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9 3h6M10 3v6.5L4.5 18.5A1.5 1.5 0 0 0 5.84 21h12.32a1.5 1.5 0 0 0 1.34-2.5L14 9.5V3" />
    <path d="M7 15h10" />
  </svg>
)
...
export const LanguageIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" />
